...
# 
# We simulated 1000 times our association analysis, for each time 25% of 
...
# list the files
files <- dir(data_path, 
             pattern = "2021-01-13-misgenotyping-25-Fisher-Bonferroni.*.assoc.fisher") 
...
ggsave(filename = "result/2021-01_histogram_simulated_25_number_significant_SNPs.pdf")
...
# save the plot
ggsave(filename = "result/2021-01_distribution_simulated_25_pvalues.pdf")
...
# save the plot
ggsave(filename = "result/2021-01_real_snps_proportion_in_simulated_25_sig_snps_df.pdf")

# save the table
write.csv(real_snps_proportion_in_simulated_sig_snps,
          file = "result/2021-01_real_snps_proportion_in_simulated_sig_snps_25")