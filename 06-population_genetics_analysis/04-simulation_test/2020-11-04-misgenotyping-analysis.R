...
# 
# We simulated 1000 times our association analysis, for each time 10% of 
...
ggsave(filename = "result/2020-11_histogram_simulated_number_significant_SNPs.pdf")
...
# save the plot
ggsave(filename = "result/2020-11_distribution_simulated_pvalues.pdf")
...
# save the plot
ggsave(filename = "result/real_snps_proportion_in_simulated_sig_snps_df.pdf")

# save the table
write.csv(real_snps_proportion_in_simulated_sig_snps,
          file = "result/real_snps_proportion_in_simulated_sig_snps_10")